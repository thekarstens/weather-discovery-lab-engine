(function () {
  ...
  var simStartUtc = Date.parse("2022-05-12T20:00:00Z"); // 3 PM CDT
  ...
  var storyMoments = [
    {
      title: "Storm Setup",
      step: "Step 1 of 6",
      html: "<p><b>3:00 PM setup.</b> A Particularly Dangerous Situation watch helps set the stage for what is to come.</p><p>Ask students: <b>Why were forecasters already so concerned this early in the afternoon?</b></p>"
    },
    {
      title: "Live Doppler",
      step: "Step 2 of 6",
  ...
  if (setupBtn) setupBtn.addEventListener("click", function () { setScene("setup"); });
  if (dopplerBtn) dopplerBtn.addEventListener("click", function () { setScene("doppler"); });
  if (warningsBtn) warningsBtn.addEventListener("click", function () { setScene("warnings"); });
  if (reportsBtn) reportsBtn.addEventListener("click", function () { setScene("reports"); });
  if (recapBtn) recapBtn.addEventListener("click", function () { setScene("recap"); });
  if (investigateBtn) investigateBtn.addEventListener("click", function () { setScene("investigate"); });
